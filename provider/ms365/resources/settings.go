...
// DirectorySetting provides access to Azure AD directory settings.
type DirectorySetting struct {
	client *msgraphsdk.GraphServiceClient
}

// NewDirectorySetting creates a new DirectorySetting resource.
func NewDirectorySetting(client *msgraphsdk.GraphServiceClient) *DirectorySetting {
	return &DirectorySetting{client: client}
}

// Name returns the resource type identifier for directory settings.
func (r *DirectorySetting) Name() string {
	return "ms365_directory_setting"
}

// Fetch retrieves all directory settings including group creation and guest access policies.
func (r *DirectorySetting) Fetch(ctx context.Context, asset core.Asset) ([]core.Resource, error) {
	// Get group settings
...
// ExternalIdentityPolicy provides access to cross-tenant access policies.
type ExternalIdentityPolicy struct {
	client *msgraphsdk.GraphServiceClient
}

// NewExternalIdentityPolicy creates a new ExternalIdentityPolicy resource.
func NewExternalIdentityPolicy(client *msgraphsdk.GraphServiceClient) *ExternalIdentityPolicy {
	return &ExternalIdentityPolicy{client: client}
}

// Name returns the resource type identifier for external identity policies.
func (r *ExternalIdentityPolicy) Name() string {
	return "ms365_external_identity_policy"
}

// Fetch retrieves cross-tenant access policies for B2B collaboration settings.
func (r *ExternalIdentityPolicy) Fetch(ctx context.Context, asset core.Asset) ([]core.Resource, error) {
