...
// RiskyUser provides access to Azure AD Identity Protection risky users.
type RiskyUser struct {
	client *msgraphsdk.GraphServiceClient
}

// NewRiskyUser creates a new RiskyUser resource.
func NewRiskyUser(client *msgraphsdk.GraphServiceClient) *RiskyUser {
	return &RiskyUser{client: client}
}

// Name returns the resource type identifier for risky users.
func (r *RiskyUser) Name() string {
	return "ms365_risky_user"
}

// Fetch retrieves all risky users from Azure AD Identity Protection.
func (r *RiskyUser) Fetch(ctx context.Context, asset core.Asset) ([]core.Resource, error) {
...
// SecureScore provides access to Microsoft Secure Score data.
type SecureScore struct {
	client *msgraphsdk.GraphServiceClient
}

// NewSecureScore creates a new SecureScore resource.
func NewSecureScore(client *msgraphsdk.GraphServiceClient) *SecureScore {
	return &SecureScore{client: client}
}
...
// SecurityAlert provides access to Microsoft 365 security alerts.
type SecurityAlert struct {
	client *msgraphsdk.GraphServiceClient
}

// NewSecurityAlert creates a new SecurityAlert resource.
func NewSecurityAlert(client *msgraphsdk.GraphServiceClient) *SecurityAlert {
	return &SecurityAlert{client: client}
}
