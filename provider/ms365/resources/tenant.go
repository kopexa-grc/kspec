...
// Tenant provides access to Microsoft 365 organization details.
type Tenant struct {
	client *msgraphsdk.GraphServiceClient
}

// NewTenant creates a new Tenant resource.
func NewTenant(client *msgraphsdk.GraphServiceClient) *Tenant {
	return &Tenant{client: client}
}

// Name returns the resource type identifier for tenants.
func (r *Tenant) Name() string {
	return "ms365_tenant"
}

// Fetch retrieves the organization details including domains and plans.
func (r *Tenant) Fetch(ctx context.Context, asset core.Asset) ([]core.Resource, error) {
...
func (r *Tenant) Discover(ctx context.Context, asset core.Asset) (map[string]int, error) {
