...
// Application provides access to Azure AD application registrations.
type Application struct {
	client *msgraphsdk.GraphServiceClient
}

// NewApplication creates a new Application resource.
func NewApplication(client *msgraphsdk.GraphServiceClient) *Application {
...
func (r *Application) Fetch(ctx context.Context, asset core.Asset) ([]core.Resource, error) {
...
// ServicePrincipal provides access to Azure AD service principals.
type ServicePrincipal struct {
	client *msgraphsdk.GraphServiceClient
}

// NewServicePrincipal creates a new ServicePrincipal resource.
func NewServicePrincipal(client *msgraphsdk.GraphServiceClient) *ServicePrincipal {
	return &ServicePrincipal{client: client}
}

// Name returns the resource type identifier for service principals.
func (r *ServicePrincipal) Name() string {
	return "ms365_service_principal"
}

// Fetch retrieves all service principals with their permissions and role assignments.
func (r *ServicePrincipal) Fetch(ctx context.Context, asset core.Asset) ([]core.Resource, error) {
