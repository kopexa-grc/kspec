...
// Device provides access to Azure AD registered devices.
type Device struct {
	client *msgraphsdk.GraphServiceClient
}

// NewDevice creates a new Device resource.
func NewDevice(client *msgraphsdk.GraphServiceClient) *Device {
	return &Device{client: client}
}

// Name returns the resource type identifier for Azure AD devices.
func (r *Device) Name() string {
	return "ms365_device"
}

// Fetch retrieves all devices registered in Azure AD.
func (r *Device) Fetch(ctx context.Context, asset core.Asset) ([]core.Resource, error) {
...
// ManagedDevice provides access to Intune managed devices.
type ManagedDevice struct {
	client *msgraphsdk.GraphServiceClient
}

// NewManagedDevice creates a new ManagedDevice resource.
func NewManagedDevice(client *msgraphsdk.GraphServiceClient) *ManagedDevice {
	return &ManagedDevice{client: client}
}

// Name returns the resource type identifier for Intune managed devices.
func (r *ManagedDevice) Name() string {
	return "ms365_managed_device"
}

// Fetch retrieves all managed devices from Microsoft Intune.
func (r *ManagedDevice) Fetch(ctx context.Context, asset core.Asset) ([]core.Resource, error) {
