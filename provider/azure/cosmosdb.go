...
// CosmosDBAccountResource represents an Azure Cosmos DB account resource scanner.
...
func (r *CosmosDBAccountResource) Name() string {
	return "azure_cosmosdb_account"
}

// Fetch retrieves Cosmos DB accounts from Azure.
func (r *CosmosDBAccountResource) Fetch(ctx context.Context, asset core.Asset) ([]core.Resource, error) {
	if r.subscriptionID == "" {
