...
// NetworkSecurityGroup represents an Azure Network Security Group resource scanner.
type NetworkSecurityGroup struct {
	credential     azcore.TokenCredential
	subscriptionID string
}

// NewNetworkSecurityGroup creates a new NetworkSecurityGroup resource scanner.
func NewNetworkSecurityGroup(credential azcore.TokenCredential, subscriptionID string) *NetworkSecurityGroup {
...
func (r *NetworkSecurityGroup) Name() string {
	return "azure_network_security_group"
}

// Fetch retrieves Network Security Groups from Azure.
func (r *NetworkSecurityGroup) Fetch(ctx context.Context, asset core.Asset) ([]core.Resource, error) {
	if r.subscriptionID == "" {
