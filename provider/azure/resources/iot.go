...
// IoTHub represents an Azure IoT Hub resource scanner.
type IoTHub struct {
	credential     azcore.TokenCredential
	subscriptionID string
}

// NewIoTHub creates a new IoTHub resource scanner.
func NewIoTHub(credential azcore.TokenCredential, subscriptionID string) *IoTHub {
	return &IoTHub{
...
func (r *IoTHub) Name() string {
	return "azure_iothub"
}

// Fetch retrieves IoT Hubs from Azure.
func (r *IoTHub) Fetch(ctx context.Context, asset core.Asset) ([]core.Resource, error) {
	if r.subscriptionID == "" {
