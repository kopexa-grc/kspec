...
// KeyVault represents an Azure Key Vault resource scanner.
type KeyVault struct {
	credential     azcore.TokenCredential
	subscriptionID string
}

// NewKeyVault creates a new KeyVault resource scanner.
func NewKeyVault(credential azcore.TokenCredential, subscriptionID string) *KeyVault {
	return &KeyVault{
...
func (r *KeyVault) Name() string {
	return "azure_keyvault_vault"
}

// Fetch retrieves Key Vaults from Azure.
func (r *KeyVault) Fetch(ctx context.Context, asset core.Asset) ([]core.Resource, error) {
	if r.subscriptionID == "" {
