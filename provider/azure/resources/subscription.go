...
// Subscription represents an Azure Subscription resource scanner.
type Subscription struct {
	credential     azcore.TokenCredential
	subscriptionID string
}

// NewSubscription creates a new Subscription resource scanner.
func NewSubscription(credential azcore.TokenCredential, subscriptionID string) *Subscription {
	return &Subscription{
...
func (r *Subscription) Name() string {
...
func (r *Subscription) Discover(ctx context.Context, asset core.Asset) (map[string]int, error) {
	if r.subscriptionID == "" {
		return nil, fmt.Errorf("subscription_id is required")
	}
