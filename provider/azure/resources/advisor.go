...
// AdvisorRecommendation represents an Azure Advisor recommendation resource scanner.
type AdvisorRecommendation struct {
	credential     azcore.TokenCredential
	subscriptionID string
}

// NewAdvisorRecommendation creates a new AdvisorRecommendation resource scanner.
func NewAdvisorRecommendation(credential azcore.TokenCredential, subscriptionID string) *AdvisorRecommendation {
...
func (r *AdvisorRecommendation) Name() string {
	return "azure_advisor_recommendation"
}

// Fetch retrieves Advisor recommendations from Azure.
func (r *AdvisorRecommendation) Fetch(ctx context.Context, asset core.Asset) ([]core.Resource, error) {
	if r.subscriptionID == "" {
