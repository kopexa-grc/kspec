...
// MariaDBServerResource represents an Azure MariaDB server resource scanner.
...
func (r *MariaDBServerResource) Name() string {
	return "azure_mariadb_server"
}

// Fetch retrieves MariaDB servers from Azure.
func (r *MariaDBServerResource) Fetch(ctx context.Context, asset core.Asset) ([]core.Resource, error) {
	if r.subscriptionID == "" {
