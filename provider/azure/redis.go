...
// RedisCacheResource represents an Azure Redis Cache resource scanner.
...
func (r *RedisCacheResource) Name() string {
	return "azure_redis_cache"
}

// Fetch retrieves Redis Cache instances from Azure.
func (r *RedisCacheResource) Fetch(ctx context.Context, asset core.Asset) ([]core.Resource, error) {
	if r.subscriptionID == "" {
