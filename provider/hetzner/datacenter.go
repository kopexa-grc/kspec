...
// DatacenterResource fetches Hetzner Cloud datacenters.
type DatacenterResource struct {
	client *hcloud.Client
}

// Name returns the resource type name.
func (r *DatacenterResource) Name() string {
	return "hcloud_datacenter"
}

// Fetch retrieves all Hetzner Cloud datacenters.
func (r *DatacenterResource) Fetch(ctx context.Context, asset core.Asset) ([]core.Resource, error) {
