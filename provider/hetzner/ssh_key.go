// Package hetzner provides a kspec provider for Hetzner Cloud infrastructure.
package hetzner
...
// SSHKeyResource fetches Hetzner Cloud SSH keys.
type SSHKeyResource struct {
	client *hcloud.Client
}

// Name returns the resource type name.
func (r *SSHKeyResource) Name() string {
	return "hcloud_ssh_key"
}

// Fetch retrieves all Hetzner Cloud SSH keys.
func (r *SSHKeyResource) Fetch(ctx context.Context, asset core.Asset) ([]core.Resource, error) {
