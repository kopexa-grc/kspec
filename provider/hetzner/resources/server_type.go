...
// ServerType fetches Hetzner Cloud server types.
type ServerType struct {
	client *hcloud.Client
}

// NewServerType creates a new ServerType resource.
func NewServerType(client *hcloud.Client) *ServerType {
	return &ServerType{client: client}
}

// Name returns the resource type name.
func (r *ServerType) Name() string {
	return "hcloud_server_type"
}

// Fetch retrieves all Hetzner Cloud server types.
func (r *ServerType) Fetch(ctx context.Context, asset core.Asset) ([]core.Resource, error) {
