...
// Server fetches Hetzner Cloud servers.
type Server struct {
	client *hcloud.Client
}

// NewServer creates a new Server resource.
func NewServer(client *hcloud.Client) *Server {
...
func (r *Server) Fetch(ctx context.Context, asset core.Asset) ([]core.Resource, error) {
