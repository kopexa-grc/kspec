...
// Firewall fetches Hetzner Cloud firewalls.
type Firewall struct {
	client *hcloud.Client
}

// NewFirewall creates a new Firewall resource.
func NewFirewall(client *hcloud.Client) *Firewall {
...
func (r *Firewall) Fetch(ctx context.Context, asset core.Asset) ([]core.Resource, error) {
