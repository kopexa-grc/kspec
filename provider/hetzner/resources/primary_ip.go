...
// PrimaryIP fetches Hetzner Cloud primary IPs.
type PrimaryIP struct {
	client *hcloud.Client
}

// NewPrimaryIP creates a new PrimaryIP resource.
func NewPrimaryIP(client *hcloud.Client) *PrimaryIP {
	return &PrimaryIP{client: client}
}

// Name returns the resource type name.
func (r *PrimaryIP) Name() string {
	return "hcloud_primary_ip"
}

// Fetch retrieves all Hetzner Cloud primary IPs.
func (r *PrimaryIP) Fetch(ctx context.Context, asset core.Asset) ([]core.Resource, error) {
