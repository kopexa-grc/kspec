...
// FloatingIP fetches Hetzner Cloud floating IPs.
type FloatingIP struct {
	client *hcloud.Client
}

// NewFloatingIP creates a new FloatingIP resource.
func NewFloatingIP(client *hcloud.Client) *FloatingIP {
	return &FloatingIP{client: client}
}

// Name returns the resource type name.
func (r *FloatingIP) Name() string {
	return "hcloud_floating_ip"
}

// Fetch retrieves all Hetzner Cloud floating IPs.
func (r *FloatingIP) Fetch(ctx context.Context, asset core.Asset) ([]core.Resource, error) {
