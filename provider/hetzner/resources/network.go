...
// Network fetches Hetzner Cloud networks.
type Network struct {
	client *hcloud.Client
}

// NewNetwork creates a new Network resource.
func NewNetwork(client *hcloud.Client) *Network {
	return &Network{client: client}
}

// Name returns the resource type name.
func (r *Network) Name() string {
	return "hcloud_network"
}

// Fetch retrieves all Hetzner Cloud networks.
func (r *Network) Fetch(ctx context.Context, asset core.Asset) ([]core.Resource, error) {
