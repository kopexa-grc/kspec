...
// Image fetches Hetzner Cloud images.
type Image struct {
	client *hcloud.Client
}

// NewImage creates a new Image resource.
func NewImage(client *hcloud.Client) *Image {
...
func (r *Image) Fetch(ctx context.Context, asset core.Asset) ([]core.Resource, error) {
