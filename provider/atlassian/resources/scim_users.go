...
// SCIMUser fetches SCIM-provisioned users.
...
// NewSCIMUser creates a new SCIMUser resource.
func NewSCIMUser(client *admin.Client, orgID string) *SCIMUser {
	return &SCIMUser{client: client, orgID: orgID}
}

// Name returns the resource type name.
func (r *SCIMUser) Name() string {
...
func (r *SCIMUser) Fetch(ctx context.Context, asset core.Asset) ([]core.Resource, error) {
