...
// SCIMGroup fetches SCIM-provisioned groups.
...
// NewSCIMGroup creates a new SCIMGroup resource.
func NewSCIMGroup(client *admin.Client, orgID string) *SCIMGroup {
	return &SCIMGroup{client: client, orgID: orgID}
}

// Name returns the resource type name.
func (r *SCIMGroup) Name() string {
...
func (r *SCIMGroup) Fetch(ctx context.Context, asset core.Asset) ([]core.Resource, error) {
