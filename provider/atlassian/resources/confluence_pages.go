...
// ConfluencePage fetches Confluence pages.
type ConfluencePage struct {
	client *confluence.Client
}

// NewConfluencePage creates a new ConfluencePage resource.
func NewConfluencePage(client *confluence.Client) *ConfluencePage {
	return &ConfluencePage{client: client}
}

// Name returns the resource type name.
func (r *ConfluencePage) Name() string {
	return "atlassian_confluence_page"
}

// Fetch retrieves Confluence pages.
func (r *ConfluencePage) Fetch(ctx context.Context, asset core.Asset) ([]core.Resource, error) {
