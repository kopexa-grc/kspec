...
// JiraProjectResource fetches Jira projects.
type JiraProjectResource struct {
	client *v3.Client
}

// Name returns the resource type name.
func (r *JiraProjectResource) Name() string {
	return "atlassian_jira_project"
}

// Fetch retrieves all Jira projects.
func (r *JiraProjectResource) Fetch(ctx context.Context, asset core.Asset) ([]core.Resource, error) {
