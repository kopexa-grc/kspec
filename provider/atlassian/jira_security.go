...
// JiraSecuritySchemeResource fetches Jira issue security schemes.
...
type JiraSecuritySchemeResource struct {
	client *v3.Client
}

// Name returns the resource type name.
func (r *JiraSecuritySchemeResource) Name() string {
...
func (r *JiraSecuritySchemeResource) Fetch(ctx context.Context, asset core.Asset) ([]core.Resource, error) {
