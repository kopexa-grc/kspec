...
// Worker fetches Workers scripts.
type Worker struct {
	client    *cloudflare.Client
	accountID string
}

// NewWorker creates a new Worker resource.
func NewWorker(client *cloudflare.Client, accountID string) *Worker {
	return &Worker{client: client, accountID: accountID}
}
...
func (r *Worker) Fetch(ctx context.Context, asset core.Asset) ([]core.Resource, error) {
...
func (r *Worker) addComputedFields(worker map[string]interface{}) {
