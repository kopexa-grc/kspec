...
// PagesProject fetches Cloudflare Pages projects.
type PagesProject struct {
	client    *cloudflare.Client
	accountID string
}

// NewPagesProject creates a new PagesProject resource.
func NewPagesProject(client *cloudflare.Client, accountID string) *PagesProject {
	return &PagesProject{client: client, accountID: accountID}
}

// Name returns the resource type name.
func (r *PagesProject) Name() string {
	return "cloudflare_pages_project"
}

// Fetch retrieves all Pages projects for the account.
func (r *PagesProject) Fetch(ctx context.Context, asset core.Asset) ([]core.Resource, error) {
...
func (r *PagesProject) addComputedFields(project map[string]interface{}) {
