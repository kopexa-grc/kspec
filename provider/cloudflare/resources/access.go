...
// AccessApplication fetches Zero Trust Access applications.
type AccessApplication struct {
	client    *cloudflare.Client
	accountID string
}

// NewAccessApplication creates a new AccessApplication resource.
func NewAccessApplication(client *cloudflare.Client, accountID string) *AccessApplication {
	return &AccessApplication{client: client, accountID: accountID}
}

// Name returns the resource type name.
func (r *AccessApplication) Name() string {
	return "cloudflare_access_application"
}

// Fetch retrieves all Access applications for the account.
func (r *AccessApplication) Fetch(ctx context.Context, asset core.Asset) ([]core.Resource, error) {
...
func (r *AccessApplication) addSecurityFields(app map[string]interface{}) {
...
// AccessPolicy fetches Zero Trust Access policies.
type AccessPolicy struct {
	client    *cloudflare.Client
	accountID string
}

// NewAccessPolicy creates a new AccessPolicy resource.
func NewAccessPolicy(client *cloudflare.Client, accountID string) *AccessPolicy {
	return &AccessPolicy{client: client, accountID: accountID}
}

// Name returns the resource type name.
func (r *AccessPolicy) Name() string {
	return "cloudflare_access_policy"
}

// Fetch retrieves all Access policies for applications.
func (r *AccessPolicy) Fetch(ctx context.Context, asset core.Asset) ([]core.Resource, error) {
	accountID := r.accountID
	if accountID == "" {
		accountID = asset.Config["account_id"]
	}
...
func (r *AccessPolicy) addSecurityFields(policy map[string]interface{}) {
