...
// ZoneSettings fetches zone security settings.
type ZoneSettings struct {
	client *cloudflare.Client
}

// NewZoneSettings creates a new ZoneSettings resource.
func NewZoneSettings(client *cloudflare.Client) *ZoneSettings {
	return &ZoneSettings{client: client}
}

// Name returns the resource type name.
func (r *ZoneSettings) Name() string {
	return "cloudflare_zone_settings"
}

// Fetch retrieves security settings for a zone.
func (r *ZoneSettings) Fetch(ctx context.Context, asset core.Asset) ([]core.Resource, error) {
...
func (r *ZoneSettings) addSecurityFlags(settings map[string]interface{}) {
	// Check zone status
