...
// Package resources provides network resource implementations for scanning
// DNS records, TLS certificates, HTTP headers, and related network configurations.
package resources
...
// DNS provides access to DNS record information for a domain.
type DNS struct{}

// NewDNS creates a new DNS resource instance.
func NewDNS() *DNS {
	return &DNS{}
}
...
func (r *DNS) Fetch(ctx context.Context, asset core.Asset) ([]core.Resource, error) {
