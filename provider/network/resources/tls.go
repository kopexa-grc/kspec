...
// TLS provides access to TLS configuration details including supported versions and ciphers.
type TLS struct{}

// NewTLS creates a new TLS resource instance.
func NewTLS() *TLS {
	return &TLS{}
}

// Name returns the resource type name.
func (r *TLS) Name() string {
	return "tls"
}

// Fetch retrieves TLS configuration from the target host specified in the asset.
func (r *TLS) Fetch(ctx context.Context, asset core.Asset) ([]core.Resource, error) {
	config := asset.Config
