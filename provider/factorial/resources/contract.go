...
// Contract fetches Factorial HR contract versions.
type Contract struct {
	client Client
}

// NewContract creates a new Contract resource.
...
func (r *Contract) Fetch(ctx context.Context, asset core.Asset) ([]core.Resource, error) {
	contracts, err := r.client.FetchPaginated(ctx, "resources/contracts/contract_versions")
	if err != nil {
		return nil, err
	}
